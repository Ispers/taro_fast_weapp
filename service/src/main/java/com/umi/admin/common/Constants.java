...
//    public static final String FILE_PATH = "http://60.204.250.12:8083/upload/";
    // Token请求头名
    ...
    // 小程序ID
    public static final String WX_APP_ID = "wx80846f14941eb044";
    // 小程序密钥
    public static final String WX_APP_SECRET = "f667258587da5d9ad9b53abc71121e02";
    // 聚合数据-短信验证码接口请求地址
    public static final String JUHE_MESSAGE_URL = "http://v.juhe.cn/sms/send?mobile=%s&tpl_id=%s&tpl_value=%s&key=%s";
    // 聚合数据-短信请求Key
    public static final String JUHE_MESSAGE_KEY = "6c84f2efc561fd516bf1bdd4147c9530";
    // 聚合数据-短信模版ID
    public static final String JUHE_MESSAGE_TPL_ID = "262041";
    // 聚合数据-短信模版变量
